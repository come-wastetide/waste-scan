...
import generateimage as generateimage
    ...
    def __init__(
        ...
        for obj in self.object_of_interests:
            ...
            while True:
                ...
                x, y = generateimage.random_point_in_background(
            ...
            self.image_data = generateimage.copy_paste(
            ...
            "images": [
                {
                    "id": 0,
                    "license": 1,
                    "file_name": self.identifier + ".jpeg.jpg",
        ...
        with tqdm.tqdm(total=self.dataset_size * 2) as pbar:
            while (images_generated < self.dataset_size) and (
                ...
                with open(base_name + ".json", "w") as f:
                    annotations = generated_image.to_coco_json()
                    for annotation in annotations["annotations"]:
                        if annotation["segmentation"] == []:
                            #we erase annotations with such a bbox
